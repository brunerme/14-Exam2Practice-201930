...
def run_test_practice_problem2a():
    ...
    actual = practice_problem2a([1,2,3,4,5,6,7], 1)
    print('expected:', expected)
    print('  actual:', actual)

    #Test 2
    expected = [-1, 4, 2, 5]
    actual = practice_problem2a([-5, 0, -2, 1], 4)
    print('expected:', expected)
    print('  actual:', actual)

    #Test 3
    expected = [2, -2, 3, -6, 4]
    actual = practice_problem2a([7, 3, 8, -1, 9], -5)
    print('expected:', expected)
    print('  actual:', actual)

    #Test 4
    expected = [14, 17, 98, 11, 12]
    actual = practice_problem2a([4, 7, 88, 1, 2], 10)
    print('expected:', expected)
    print('  actual:', actual)
...
def practice_problem2b(sequence):
    ...
    for k in range(len(sequence)):
        if len(sequence[k]) > 0:
            letter_string = sequence[k]
            string = string + letter_string[0]
    return string
